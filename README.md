...
- [Donate](#donate)
  - [Financial donation](#financial-donation)
    - [Become Github Sponsor](https://github.com/AdnanHodzic/auto-cpufreq/blob/master/README.md#become-github-sponsor)
    - [pump.fun](https://github.com/AdnanHodzic/auto-cpufreq/blob/master/README.md#pumpfun)
    - [BitCoin](#bitcoin)
    - [Paypal](#paypal)
...
> As auto-cpufreq relies on git based versioning, users are advised to install `auto-cpufreq`  using `git clone` method only. Downloading source code as a zip/from release will emit build errors like [these](https://github.com/AdnanHodzic/auto-cpufreq/issues/623).
