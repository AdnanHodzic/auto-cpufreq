...
auto_cpufreq_stats_path = '/var/' + ('snap/auto-cpufreq/current' if IS_INSTALLED_WITH_SNAP else 'run') + '/auto-cpufreq.stats'

def get_stats():
    if isfile(auto_cpufreq_stats_path): return getoutput('tail -n 50 '+auto_cpufreq_stats_path)
...
class AboutDialog(Gtk.Dialog):
    def __init__(self, parent):
        ...
        self.python = Gtk.Label(label='Python '+python_version())
